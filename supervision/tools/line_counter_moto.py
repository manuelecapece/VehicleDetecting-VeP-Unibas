...
class LineCounterAnnotatorMoto:
    def __init__(
        self,
        thickness: float = 2,
    ...
    def annotateMoto(self, frame: np.ndarray, line_counter_moto: LineCounterMoto) -> np.ndarray:
        """
        ...
        cv2.line(
            frame,
            line_counter_moto.vector.start.as_xy_int_tuple(),
            line_counter_moto.vector.end.as_xy_int_tuple(),
            self.color.as_bgr(),
            self.thickness,
        ...
        in_text = f"Motorcycle in: {line_counter_moto.in_count}"
        out_text = f"Motorcycle out: {line_counter_moto.out_count}"
        ...
        #DX
        in_text_x = int(1630) #cambiare qui
        in_text_y = int(100) #cambiare qui
        #SX
        out_text_x = int(50) #cambiare qui
        out_text_y = int(100) #cambiare qui
