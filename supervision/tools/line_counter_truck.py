...
class LineCounterAnnotatorTruck:
    def __init__(
        self,
        thickness: float = 2,
    ...
    def annotateTruck(self, frame: np.ndarray, line_counter_truck: LineCounterTruck) -> np.ndarray:
        """
        ...
        cv2.line(
            frame,
            line_counter_truck.vector.start.as_xy_int_tuple(),
            line_counter_truck.vector.end.as_xy_int_tuple(),
            self.color.as_bgr(), 
            self.thickness,
        ...
        in_text = f"Truck in: {line_counter_truck.in_count}"
        out_text = f"Truck out: {line_counter_truck.out_count}"
        ...
        in_text_y = int(200) #cambiare qui
        #SX
        out_text_x = int(50) #cambiare qui
        out_text_y = int(200) #cambiare qui
